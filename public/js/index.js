...
ll.done(function (response) {
  if (response.length === 0) {
    $("#no").append("<div>"+"sorry, there are no concerts related to this artist in your hood."+"<br><br><iframe src='http://giphy.com/gifs/6gLyE15StAs3C/html5' frameBorder='0'></iframe></div>");
  } else {
